                ...
                <AnimatePresence>
                  {unreadCount > 0 && (
                    <motion.div
                      ...
                      animate={{ scale: 1 }}
                      exit={{ scale: 0 }}
                      className={`absolute -bottom-1 -right-1 w-5 h-5 flex items-center justify-center bg-emerald-500 text-white text-xs font-bold rounded-full border-2 border-gray-800`}
                    >
                      {displayCount}
                    </motion.div>
                  )}
